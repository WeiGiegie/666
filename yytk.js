...
[rewrite_local]
# >18+夜艳
^https?:\/\/web\w+.yeyan\w+.xyz\/api\/(user\/personal|community\/edit|adv\/) url script-response-body yeyan.js
^https?:\/\/web\w+.yeyan\w+.xyz\/api\/community\/xq_community url script-request-header yytk.js
